...
ax_cloud.set_title(f"ATHENS Init: {run_date} {run_hour:02d}Z", fontsize=14, fontweight='bold', color='black', y=1.5)
...
plt.savefig("athens_meteogram.png", dpi=96, bbox_inches='tight', pad_inches=0)
plt.close(fig)
