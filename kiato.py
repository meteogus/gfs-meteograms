...
ax_cloud.set_title(f"KIATO Init: {run_date} {run_hour:02d}Z", fontsize=14, fontweight='bold', color='black', y=1.5)
...
plt.savefig("kiato_meteogram.png", dpi=96, bbox_inches='tight', pad_inches=0)
plt.close(fig)
...
with open("kiato_meteogram.png", "rb") as file:
    ftp.storbinary("STOR kiato_meteogram.png", file)
