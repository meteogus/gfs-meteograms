...
ax_cloud.set_title(
    f"Ioannina GFS: {latest_run_time:%d-%m-%Y} ({latest_run_time:%HZ})",
...
for i in range(0, len(time_nums_3h), 2):  # every 6h
...
plt.savefig("ioannina.png", dpi=96, bbox_inches='tight', pad_inches=0)
plt.close(fig)
